...
This module provides a reader for FAISS vector indices, supporting efficient
approximate nearest neighbor search for global index queries.
"""
...
class FaissVectorGlobalIndexReader(GlobalIndexReader):
    ...
    Corresponds to Java's FaissVectorGlobalIndexReader.
    """
